...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Create workouts
        Workout.objects.create(name='Hero HIIT', description='High intensity for heroes', recommended_for='Marvel')
        Workout.objects.create(name='Power Circuit', description='Strength for DC', recommended_for='DC')
